...
const tabsListVariants = cva('flex items-center shrink-0', {
  variants: {
    variant: {
      default: 'bg-zinc-800/60 p-1 border border-white/5',
      button: '',
...
const tabsTriggerVariants = cva(
  'shrink-0 cursor-pointer whitespace-nowrap inline-flex justify-center items-center font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:shrink-0 [&_svg]:text-muted-foreground [&:hover_svg]:text-primary [&[data-state=active]_svg]:text-[#41F20A] [&[data-state=active]_svg]:text-primary',
  {
    variants: {
      variant: {
        default:
          'text-zinc-400 data-[state=active]:bg-zinc-950 data-[state=active]:text-[#41F20A] hover:text-white data-[state=active]:shadow-xs data-[state=active]:shadow-black/5',
        button:
        ...
        line: 'border-b-2 text-zinc-400 border-transparent data-[state=active]:border-[#41F20A] hover:text-white data-[state=active]:text-[#41F20A] data-[state=active]:border-[#41F20A]',
      },
      size: {
